...
<body>
<form name="load4UserGroupMain.action" method="post" name="form1" id="form1">
              ...
              <tr>
                <td valign="middle" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div1">
					  <tr>
						<td height="21" background="image/index_main_div_titleBg.gif"><img style="margin-left:5px;" src="image/index_main_div_left.gif" width="6" height="2" align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">部门设置</span></td>
					  </tr>
					</table>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_table">
					  ...
					  <tr>
					    <td height="11"><img src="image/t1.gif" align="absmiddle"> <span style="font-size:14; font-weight:bold;">部门列表</span></td>
				      </tr>
					  <tr>
					    <td height="16" valign="top"><br/>
				        <img src="image/s3.gif" width="62" height="22" onclick="javascript:window.location.href='load4AddUserGroup.action'"><img src="image/s7.gif" width="59" height="22"><img src="image/shuxing.gif" width="62" height="22"></td>
			          </tr>
					  <tr>
							  ...
							  <tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_row">
                                  <tr>
                                    ...
                                    <td width="30%" align="left" background="image/select_title_title.jpg"><strong>部门名称</strong></td>
                                    <td width="26%" align="center" background="image/select_title_title.jpg"><strong>部门负责人</strong></td>
                                    <td width="26%" align="center" background="image/select_title_title.jpg"><strong>部门职能</strong></td>
                                    <td width="14%" align="center" background="image/select_title_title.jpg"><strong>人员设置</strong></td>
                                  </tr>
                                  
                                  <s:iterator value="#request.userGroupList" id="suserGroup">
                                  <tr class="select_content_bg">
                                    <td align="center"><s:if test="#session.userGroup_ids==null">

										<input type="checkbox" name="userGroup_id"
											value="${suserGroup.id}">
									</s:if> <s:else>
										<s:set name="flag" value="1" />
										<s:iterator value="#session.userGroup_ids" id="c_ids">
											<s:if test="#c_ids==#suserGroup.id">
												<input type="checkbox" name="userGroup_id"
													value="${suserGroup.id}" checked="checked">
                                    ...
                                    <td>${suserGroup.name}</td>
                                    <td align="center">${suserGroup.principal}</td>
                                    <td align="center">${suserGroup.incumbent}</td>
                                    <td align="center"><a href="javascript:openSetUserWindow('${suserGroup.id}');" class='normal'>设置</a></td>
                                  </tr>
                                  </s:iterator>
