...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkBoxNum() {
            if ($("input[name='accessGroup_id']:checked").length > 0) {
                return $("input[name='accessGroup_id']:checked").length;
            } else {
                return 0;
            }
        }
        ...
        function openTreeWindow(accessGroup_id) {
            window.open("accessGroup/toSetAccessGroup?accessGroupId=" + accessGroup_id, "_blank",
        ...
        function toChange() {
            ...
            var num = $(".select_content_bg input").attr("checked", flag);
...
<form name="accessGroup/accessGroupList" method="post" name="form1" id="form1">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td height="21" background="image/index_main_div_titleBg.gif"><img
                                ...
                                style="font-weight: bold; font-size: 12px;">查询权限</span></td>
                    </tr>
                </table>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td height="21" background="image/index_main_div_titleBg.gif"><img
                                style="margin-left: 5px;" src="image/index_main_div_left.gif"
                                width="6" height="2" align="absmiddle">&nbsp;<span
                                style="font-weight: bold; font-size: 12px;">查询权限组搜索</span></td>
                    </tr>
                    <tr>
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    ...
                                    <td width="17%"><input type="text" name="name" value="${accessGroup.name }"
                                    ...
                                    <td width="10%" align="left"><img src="image/s2.gif" onclick="clearSearchArea();"
                                                                      width="62" height="22"></td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td height="11"><img src="image/t1.gif" align="absmiddle">
                            <span style="font-size: 14px; font-weight: bold;">查询权限列表</span></td>
                    </tr>
                    <tr>
                        <td height="16" valign="top"><br/>
                            <img src="image/s3.gif" width="62" height="22"
                                 onclick="javascript:window.location.href='load4AddAccessGroup.action'"><img
                                    src="image/s7.gif" width="59" height="22"></td>
                    </tr>
                    <tr>
                                        ...
                                        <select name="_pageNum" onchange="toUrl('_pageNum_up','_null');"
                                            ...
                                            <c:forEach begin="1" end="${pager.totalPage}" varStatus="sta">
                                                ...
                                                <option value="${sta.count}"
                                                        <c:if test="${pager.page==sta.count}">selected="selected"</c:if>>
                                                    第${sta.count}页
                                                </option>
                                            </c:forEach>
                                            ...
                                            <tr>
                                                <td width="4%" height="28" align="center"
                                                    background="image/select_title_title.jpg"><input
                                                        type="checkbox" name="checkbox" value="checkbox" id="ids"
                                                        onclick="toChange()"></td>
                                                <td width="14%" align="left"
                                                    background="image/select_title_title.jpg"><strong>编号</strong></td>
                                                <td width="30%" align="center"
                                                    background="image/select_title_title.jpg"><strong>名称</strong></td>
                                                <td width="52%" align="center"
                                                    background="image/select_title_title.jpg">
                                                    <strong>可查看的范围</strong><strong></strong></td>
                                            </tr>
                                            <c:forEach items="${accessGroupList }" var="saccessGroup">
                                                <tr class="select_content_bg">
                                                    <td align="center"><input type="checkbox" name="accessGroup_id"
                                                                              value="${saccessGroup.id}"
                                                                              onclick="updateNum();"></td>
                                                    <td>${saccessGroup.id}</td>
                                                    <td align="center">${saccessGroup.name}</td>
                                                    <td align="center">
                                                        <span onclick="openTreeWindow('${saccessGroup.id}')"
                                                              style="cursor: pointer">设置</span>
                                                        <span onclick="openTreeWindow2('${saccessGroup.id}')"
