...
<head>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            $('#payDateStr').simpleDatepicker({startdate: 1960, enddate: 2060});
            //是否已经有了数据

            if ('' != '${gather.payDateStr}') {
                $('#payDateStr').val('${gather.payDateStr}');
            }
            if ('' != '${gather.createtimeStr}') {
                $('#createtimeStr').val('${gather.createtimeStr}');
            }

            if ('' != '${gather.updatetimeStr}') {
                $('#updatetimeStr').val('${gather.updatetimeStr}');
            }
            ...
            //判断状态显示时间颜色
            if ($('#payDateStr').val() != "点击显示时间列表") {
                $('#payDateStr').removeClass("addTimeInit");
                $('#payDateStr').addClass("addTimeClick");
            }
...
<form name="gatherForm" method="post" id="gatherForm" action="gatherAdd.action">
    ...
    <input type="hidden" name="CType" value="${company.CType}"/>
        ...
        <tr>
            <td valign="middle">
                <s:if test="#request.needGatherSize==null">
                    <img src="image/s10.gif" width="58" height="22" onclick="submitForm();"><img src="image/s8.gif"
                                                                                                 width="59" height="22">
                </s:if>
                ...
                <s:elseif test="#request.gather.status=='草稿'">
                    <img src="image/s10.gif" width="58" height="22" onclick="submitForm();"><img src="image/tijiao.gif"
                                                                                                 onclick="javascript:window.location.href='gatherSubmit.action?edit_id=${edit_id}&CId=${CId }'"><img
                        src="image/s8.gif" width="59" height="22">
                </s:elseif>
                <s:elseif test="#request.gather.status=='待审核'">
                    <img src="image/shenhe.gif"
                         onclick="javascript:window.location.href='gatherAuditingPass.action?edit_id=${edit_id}&CId=${CId }'"><img
                        src="image/bohui.gif" onclick="openWindow4ToDraft();"><img src="image/s8.gif" width="59"
                                                                                   height="22">
                </s:elseif>
                <s:else>
            ...
            <td valign="middle">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div1">
                    <tr>
                        <td height="21" valign="top" background="image/index_main_div_titleBg.gif"><img
                                ...
                                align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">客户基本信息</span>
                        </td>
                    </tr>
                    <tr>
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"
                                ...
                                <tr>
                                    ...
                                    <td style="background-color:#FFFFFF;"><input type="text" name="CName"
                                                                                 value="${company.name}"
                                ...
                                <tr>
                                    <td>客户等级:</td>
                                    <td style="background-color:#FFFFFF;">${company.grade}</td>
                                    <td align="left">区域名称:</td>
                                    <td style="background-color:#FFFFFF;">${company.regionName}</td>
                                </tr>
                                <tr>
                                    <td>省份:</td>
                                    <td style="background-color:#FFFFFF;">${company.province}</td>
                                    <td align="left">城市:</td>
                                    <td style="background-color:#FFFFFF;">${company.city}</td>
                                </tr>
                                <tr>
                                    <td>联系地址:</td>
                                    <td style="background-color:#FFFFFF;">${company.address}</td>
                                    <td align="left">电子邮件:</td>
                                    <td style="background-color:#FFFFFF;">${company.email}</td>
                                </tr>
                                <tr>
                                    <td>电话一:</td>
                                    <td style="background-color:#FFFFFF;">${company.tel1}</td>
                                    <td align="left">电话二:</td>
                                    <td style="background-color:#FFFFFF;">${company.tel2}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div2">
                    <tr>
                        <td height="21" valign="top" background="image/index_main_div_titleBg.gif"><img
                                style="margin-left:5px;" src="image/index_main_div_left.gif" width="6" height="2"
                                align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">收款单信息</span></td>
                    </tr>
                    <tr>
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"
                                ...
                                <tr>
                                    ...
                                    <td width="562" style="background-color:#FFFFFF;"><input type="text" name="code"
                                                                                             class="style_1"
                                                                                             value="${todayStr}${gather.code}">
                                    </td>
                                    <td width="93" align="left">收款时间:</td>
                                    <td width="580" style="background-color:#FFFFFF;"><input type="text"
                                                                                             name="payDateStr"
                                                                                             class="style_1" value=""
                                                                                             id="payDateStr"></td>
                                </tr>
                                <tr>
                                    <td>付款人:</td>
                                    <td style="background-color:#FFFFFF;"><input type="text" name="payer"
                                                                                 class="style_1"
                                                                                 value="${gather.payer }"></td>
                                    <td align="left">经手人:</td>
                                    <td style="background-color:#FFFFFF;"><input type="text" name="handler"
                                                                                 class="style_1"
                                                                                 value="${gather.handler }"></td>
                                </tr>
                                <tr>
                                    <td>付款方式:</td>
                                    ...
                                    <td style="background-color:#FFFFFF;"><input type="text" name="billCode"
                                                                                 class="style_1"
                                                                                 value="${gather.billCode }"></td>
                                </tr>
                                <tr>
                                    <td>备注:</td>
                                    <td colspan="3"><textarea name="remark"
                                                              class="addCText2">${gather.remark }</textarea></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div3">
                    <tr>
                        <td height="21" valign="top" background="image/index_main_div_titleBg.gif"><img
                                style="margin-left:5px;" src="image/index_main_div_left.gif" width="6" height="2"
                                align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">应收款项列表</span>
                        </td>
                    </tr>
                    <tr>
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"
                                ...
                                <s:iterator value="#request.needGatherList" id="bneedGather">
                                    <tr>
                                        <td>
                                            <s:if test="#request.edit_id==null ||#request.edit_id==''">
                                                <input type="checkbox" name="gatherChecked" value="${bneedGather.id}">
                                            </s:if>
                                            <s:else>
                                                <s:set name="flag" value="1"/>
                                                <s:iterator value="#request.gather.BNeedGathers" id="tmp_needGather">
                                                    <s:if test="#tmp_needGather.id==#bneedGather.id">
                                                        <input type="checkbox" name="gatherChecked"
                                        ...
                                        <td align="left">${bneedGather.total}</td>
                                        <td>${bneedGather.payed}</td>
                                        <td>${bneedGather.balance}</td>
                                        <td><span style="background-color:#FFFFFF;">
	                           
	                              <input type="text" name="money" id="${bneedGather.id}" class="style_1"
                                         value="${bneedGather.total - bneedGather.payed}" readonly="readonly">
	                            </span></td>
                                    </tr>
                                </s:iterator>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div4">
                    <tr>
                        <td height="21" valign="top" background="image/index_main_div_titleBg.gif"><img
                                style="margin-left:5px;" src="image/index_main_div_left.gif" width="6" height="2"
                                align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">驳回原因</span></td>
                    </tr>
                    <tr>
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"
                                ...
                                <tr>
                                    <td width="66">驳回原因:</td>
                                    <td colspan="4"><textarea name="remark" class="addCText2"
                                                              readonly="readonly">${gather.auditIdea}</textarea></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"
                                ...
                                <tr>
                                    ...
                                    <td width="40%"><input name="createtimeStr" id="createtimeStr"
                                                           value="${gather.createtimeStr}" type="text"
                                                           class="addCText" id="createtimeStr" readOnly="readOnly"></td>
                                    <td width="2%">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>修改人:</td>
                                    <td><input name="updater" type="text" class="addCText" value=""
                                               id="updater" readOnly="readOnly"></td>
                                    <td align="left">修改日期:</td>
                                    <td><input name="updatetimeStr" type="text" value='${gather.payDateStr}'
                                               class="addCText"
