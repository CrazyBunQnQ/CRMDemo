...
<body>
<form name="userGroupForm" method="post" id="userGroupForm" action="userGroupAdd.action">
    ...
    <table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_main_table">
        <tr>
            <td height="26" width="100%"><span style="color:#002450; font-size:13px; font-weight:bold;">　部门新建</span>
            </td>
        </tr>
    </table>
    ...
    <table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_content">
        ...
        <tr>
            <td valign="middle"><img src="image/s10.gif" width="58" height="22" style="cursor: pointer;"
                                     onclick="submitForm();"><img src="image/s8.gif" width="59" height="22"></td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"
                                ...
                                <tr>
                                    <td width="10%">部门名称:</td>
                                    <td width="37%"><input type="text" name="name" value="${userGroup.name }"
                                                           class="addCText"></td>
                                ...
                                <tr>
                                    <td>部门负责人:</td>
                                    <td><input type="text" name="principal" value="${userGroup.principal}"
                                               class="addCText"></td>
                                    <td align="left">&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><textarea name="incumbent"
                                                              class="addCText2">${userGroup.incumbent}</textarea></td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>备注</td>
                                    <td colspan="3"><textarea name="remark"
                                                              class="addCText2">${userGroup.remark}</textarea></td>
                                    <td>&nbsp;</td>
                                </tr>
                            </table>
                        </td>
