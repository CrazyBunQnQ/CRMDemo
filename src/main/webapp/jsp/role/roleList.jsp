...
<head>
    ...
    <script type="text/javascript">
        ...
        function toChange() {
            ...
            var flag = $("#select_row input[name='checkbox']").attr("checked");
            if (flag) {
                $("#select_row input[name='role_id']").attr("checked", true);
            } else {
                $("#select_row input[name='role_id']").attr("checked", false);
            }
            updateNum();
        }
    </script>
                ...
                <table width="100%" srole="0" cellspacing="0" cellpadding="0" id="index_main_div1">
                    ...
                    <tr>
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" srole="0" cellspacing="0" cellpadding="0" height="100%"
                                   id="selectTable">
                                <tr>
